...
class Tickets extends AbstractModifier
{
    ...
    {
        $children = [
            'list_tickets' => $this->getStockMovements(),
        ];
        return $children;
    }

    protected function getStockMovements(){
        $listingTarget = 'angel_raffleclient_ticket_index';
        return [
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'update_url' => $this->urlBuilder->getUrl('mui/index/render', ['product_id' => $this->request->getParam('id')]),
                        'realTimeLink' => false,
                        'dataLinks' => [
                            'imports' => false,
                            'exports' => true
