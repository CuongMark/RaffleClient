...
{
    const GROUP_REVIEW = 'raffle_review';
    const GROUP_CONTENT = 'content';
    const DATA_SCOPE_REVIEW = 'grouped';
    const SORT_ORDER = 20;
    const LINK_TYPE = 'associated';

    protected $_fieldsetContent = 'Raffle Prizes';
    ...
    public function modifyMeta(array $meta)
    {
        ...
        $meta[static::GROUP_REVIEW] = [
            'children' => [
                ...
                'raffle_review_listing' => [
                    'arguments' => [
                        'data' => [
                            'config' => [
                                'autoRender' => true,
                                'componentType' => 'insertListing',
                                'dataScope' => 'raffle_review_listing',
                                'externalProvider' => 'raffle_review_listing.raffle_review_listing_data_source',
                                'selectionsProvider' => 'raffle_review_listing.raffle_review_listing.product_columns.ids',
                                'ns' => 'raffle_review_listing',
